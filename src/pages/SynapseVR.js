    ...
    <div className='page'>
      ...
      <Container>
        ...
        <Container className='img-container' style={{ paddingTop: 0 }}>
          ...
          “Designers and developers at bp lack access to interactive and engaging learning materials when they are trying to 
          expand their skill set into 3D technologies. This hinders their ability to quickly and effectively utilise AI for 
          up-skilling purposes across a variety of roles.”
          </span>
        </Container>
        <p>
